...
export default function Signup() {
  return (
    <Layout title="Create your VoiceInk account" description="Sign up for VoiceInk - free voice-to-text for macOS">
      <div className="vi-auth">
        <div className="vi-auth__card">
          ...
          <h1 className="vi-auth__title">Create your account</h1>
          <p className="vi-auth__subtitle">Start transcribing for free in under a minute</p>
          ...
          <form className="vi-auth__form" onSubmit={(e) => e.preventDefault()}>
            <div className="vi-auth__field">
              <label className="vi-auth__label" htmlFor="name">Full name</label>
              <input
            ...
            <div style={{
              ...
              <a href="/terms" style={{ color: 'var(--vi-text-secondary)', textDecoration: 'underline' }}>Terms</a>
              {' '}and{' '}
              <a href="/privacy" style={{ color: 'var(--vi-text-secondary)', textDecoration: 'underline' }}>Privacy Policy</a>
            </div>
          </form>
